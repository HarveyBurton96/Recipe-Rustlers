# Generated by Django 3.2.16 on 2023-01-26 14:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', cloudinary.models.CloudinaryField(default='no_image', max_length=255, verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='recipe.post')),
            ],
            options={
                'ordering': ['created_on'],
            },
