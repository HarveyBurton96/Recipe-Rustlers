...
To record my aglie development I used the inbuilt projects in Github to track my User stories.
...
At the conception of the project I creating three mockups of the key pages so i could define the style i wanted to go with. I didn't create mockups of the other pages as most where small changes to one of the three pages I had already made mockups for.

- ### Mockup of homepage
![Wireframe homepage image](documentation/website_images/wireframe_homepage.png)

- ### Mockup of popular recipe page
![Wireframe popular page image](documentation/website_images/wireframe_popular_page.png)

- ### Mockup of detailed recipe page
...
- ### Recipe details
    ...
    - The user if they are signed in are able to click on the heart to like the post if the post is empty then the user can like the post once the post is liked the heart fills in. This can be clicked on again to remove the users like if they have changed there mind on the recipe.
...
- ### Register
    - If the user chooses to register for an account they are offered a link to the sign in page incase they have already made an account.
...
- ### Sign in
    - If the user clicks login a link is offered to the Register page incase they don't already have an account.
    - The page was craeted using allauth which validates the username and password match.
    ![Sign in image](documentation/website_images/Sign_in.png)

- ### Logout
    - If the user clicks logout the page asks they user if they are sure.
...
- ### Manual testing
    ...
    - #### Manage recipes
        In the admin pannel i am able to add, edit, remove, and view all data in the models. 
    ...
    - #### Site list
        All published recipes are viewable in to different orders either by newest or most popular. 
    ...
    - #### Account registration
        A user can create an account by clicking on the register tab or log into an excisting account by the sign in tab
    ...
    - #### Like / unlike
        A signed in user can like and remove their like on any recipe. When the recipe is liked the heart is filled in and if the recipe is not liked the heart is whloe
...
- ### Issues found during development
    ...
    Was producing this error when i tried to save the recipe
    ![Author ID issue error message image](documentation/testing_images/Author_id_issue_part1.png)

    I found the solution was to include 'instance' between form.author to acpture the current user.
    ...
    With the help of my mentior we were able to find the issue was the queryset was set to the wrong objects. Once that was amended the page loaded correctly. This is the fixed code. 
